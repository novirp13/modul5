        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (cek()) {
                            Snackbar.make(view, "Harap Diisi", Snackbar.LENGTH_LONG)
                ...
                public void onClick(View view) {
                    ...
                    switch (id) {
                        case R.id.colordefault:
                            optionShapeColor = R.id.colordefault;
                            shapeColor = R.color.colDefault;
                            break;
                        case R.id.colorRed:
                            optionShapeColor = R.id.colordefault;
                            shapeColor = R.color.colRed;
                            break;
                        case R.id.colorBlue:
                            optionShapeColor = R.id.colordefault;
                            shapeColor = R.color.colBlue;
                            break;
                        case R.id.colorGreen:
                            optionShapeColor = R.id.colordefault;
                            shapeColor = R.color.colGreen;
                            break;
                    }
                    dialog2.dismiss();
