...
public class Adapters extends RecyclerView.Adapter<Adapters.AdapterViewHolder> {
    ...
    public void onBindViewHolder(AdapterViewHolder holder, int position) {
        ...
        long ident = mCursor.getLong(mCursor.getColumnIndex(TodoPointer.TodoEntry._ID));
        String aktifitas = mCursor.getString(mCursor.getColumnIndex(TodoPointer.TodoEntry.COLUMN_NAMA_));
        String deskripsi = mCursor.getString(mCursor.getColumnIndex(TodoPointer.TodoEntry.COLUMN_DESKRIPSI));
        int priority = mCursor.getInt(mCursor.getColumnIndex(TodoPointer.TodoEntry.COLUMN_PRIOTIRTY));
